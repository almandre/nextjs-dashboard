...
export async function createInvoice(prevState: InvoiceFormState, formDataInput: FormData) {
    const formDataEntries = formDataInput.entries();
    const rawFormData = Object.fromEntries(formDataEntries);
...
function redirectToInvoicesPage() {
